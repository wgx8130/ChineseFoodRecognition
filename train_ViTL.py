...
from timm.models.vision_transformer import vit_large_patch16_224_in21k
...
#                            transform=data_transform["val"])
    ...
    model = vit_large_patch16_224_in21k(pretrained=True, num_classes=208).to(device)
...
#    scheduler = lr_scheduler.LambdaLR(optimizer, lr_lambda=lf)
    ...
    for epoch in range(args.epochs):
        ...
        if val_acc > best_acc:
            best_acc = val_acc
            print(epoch)
            torch.save(model.state_dict(), "./weights/L16model-best.pth")
